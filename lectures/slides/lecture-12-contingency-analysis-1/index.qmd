...
description: "Introduces methods for quantifying the strength of association between two categorical variables using 2×2 contingency tables. We develop conditional probability (risk), relative risk, odds, and the odds ratio, and discuss when each measure is appropriate based on study design."
format:
  revealjs:
    fig-width: 8
    fig-height: 6
