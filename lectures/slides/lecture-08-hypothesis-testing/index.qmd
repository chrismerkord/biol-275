...
::: {.column width="50%"}
![A European common toad (\*Bufo bufo\*) with a white ball tied to its head, illustrating a behavioral experiment concept. Created by ChatGPT.](images/toad-with-ball.png){#fig-toad-with-ball fig-alt="Square, photorealistic AI-generated image of a European common toad (*Bufo bufo*) on a white background with a white ping-pong ball slightly smaller than its head tied on top using a string that runs around the ball and under the toad’s throat; the toad is lifting one forelimb above its eye in an unsuccessful attempt to touch the ball." fig-align="center" width="80%"}
:::
:::::
...
::: {.column width="50%"}
![Graphical illustration of the results of the study, showing more toads used their right hands than left. Generated by ChatGPT. Note: the actual sample size in the study was 18, not 16 as shown in this image.](images/toad-results.png){#fig-toad-results fig-align="center" width="80%"}
:::
:::::
...
\\ \operatorname{Pr}[X = 14]+\operatorname{Pr}[X = 15]+\operatorname{Pr}[X = 16]+\operatorname{Pr}[X = 17]+\operatorname{Pr}[X = 18] =
\\ 0.0015
$$
