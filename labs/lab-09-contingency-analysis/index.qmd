...
-   Use [`mutate()`](https://dplyr.tidyverse.org/reference/mutate.html) to create a new variable.

    -   Inside mutate, use [`case_when()`](https://dplyr.tidyverse.org/reference/case_when.html). to recode the values.
