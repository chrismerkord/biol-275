...
1.  Download the PDF document to your computer using the More \> Export command in the Files tab ([video example](https://www.youtube.com/watch?v=cAHCMpPJx3k)).
...
```{{r}}
# code to read/get the data into R
