...
-   [Dryad Datasets](dryad-datasets.qmd). A curated, general purpose data repository. You can search through it to find an interesting dataset. Here are two examples (but you should find your own):
